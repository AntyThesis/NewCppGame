...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UhealthComponent_Statics::NewProp_Health = { "Health", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UhealthComponent, Health), Z_Construct_UScriptStruct_FMyHealthStruct, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Health_MetaData), NewProp_Health_MetaData) }; // 3678350482
...
struct Z_CompiledInDeferFile_FID_Unreal_Projects_NewCppGame_Source_NewCppGame_healthComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UhealthComponent, UhealthComponent::StaticClass, TEXT("UhealthComponent"), &Z_Registration_Info_UClass_UhealthComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UhealthComponent), 3233666045U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_NewCppGame_Source_NewCppGame_healthComponent_h_2601198766(TEXT("/Script/NewCppGame"),
